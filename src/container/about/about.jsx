...
const About = () => {
  ...
  const skills = [
    "HTML5", "CSS3", "JavaScript", "React", "Java", "Python", "Django",
    "Git", "Responsive Design", "UI/UX Design"
  ];
      ...
      <div className="about-content">
        ...
        <div className="info-section">
          <div className="info-buttons">
            ...
            <button 
              className={`info-button ${activeSection === 'certifications' ? 'active' : ''}`}
          ...
          <div className="info-content">
            ...
            {activeSection === 'certifications' && renderList(certifications)}
          </div>
        </div>
      </div>
    </section>
